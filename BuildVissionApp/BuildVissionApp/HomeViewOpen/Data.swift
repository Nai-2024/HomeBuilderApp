...
class BlackBoxData {
    ...
    // Image arrays for different locations
    let torontoImages: [String]
    let oakvilleImages: [String]
    let oshawaImages: [String]
    let markhamImages: [String]
    let northYorkImages: [String]
    let vaughanImages: [String]
    
    // Initializer to populate data
    init() {
        self.titles = [
            "CUSTOM HOME BUILDING",
            "HOME RENOVATION",
        ...
        self.torontoImages = ["Toronto1","Toronto2", "Toronto3", "Toronto4", "Toronto5", "Toronto6", "Toronto7"]
        self.oakvilleImages = ["OA1", "OA2", "OA3", "OA4", "OA5", "OA6", "OA7"]
        self.oshawaImages = ["Oshawa1","Oshawa2", "Oshawa3", "Oshawa4", "Oshawa5", "Oshawa6", "Oshawa7"]
        self.markhamImages = ["Markham1","Markham2", "Markham3", "Markham4", "Markham5", "Markham6", "Markham7"]
        self.northYorkImages = ["NY1", "NY2", "NY3", "NY4", "NY5", "NY6", "NY7"]
        self.vaughanImages = ["Vaughan1","Vaughan2", "Vaughan3", "Vaughan4", "Vaughan5", "Vaughan6", "Vaughan7"]
    }
}
